...
CUDA_VISBLE_DEVICES=3,4 python icae_recommend_keyword_dataset.py  --attack_mode $attack_mode --mean_compression_rate $mean_compression_rate --model_max_length $maxlen --fixed_mem_size $mem --lora_r $r --output_dir $ICAE_MODEL_PATH --model_name_or_path $BASE_MODEL --bf16 --train False
