...
from dataloader.data_loader import FullMultiOutputDataset, PartialMultiOutputDataset
...
for idx in tqdm(range(len(dataset)), desc="Running attacks"):
    ...
    base_text = sample['outputs'][0]  # select output1 as the base text
    target_text = sample['requirement']  # requirement
